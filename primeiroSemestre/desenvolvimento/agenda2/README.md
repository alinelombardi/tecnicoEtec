...
Agenda dedicada apenas para conceitos de lógica de programação, variáveis e constantes, operadores relacionais, lógicos, aritméticos e tabela verdade.

---

> Conteúdo extra: Curso de Java para Iniciantes – Grátis, Completo e com Certificado (Gustavo Guanabara).
...
*Informações retiradas no link [Curso de Java #01 - História do Java - Gustavo Guanabara](https://www.youtube.com/watch?v=sTX0UEplF54&list=PLHz_AreHm4dkI2ZdjTwZA4mPMxWTfNSpR), de 2 de março de 2015.*

---

> Atividades realizadas em linguagem de programação Java durante os vídeos:
